...
function loadPOIS(e, url) {
	...
	$.get(url, function (osmDataAsJson) {
		...
		for (var poi in osmDataAsJson.elements) {
			...
			var details_data = {"home": {"content": `<h1>${ ((poi.tags["name"] == undefined) ? ((poi.tags["amenity"] == "toilets") ? langRef[document.body.id][languageOfUser].TOILET : langRef[document.body.id][languageOfUser].PDV_UNNAME) : poi.tags["name"]) }</h1><h2>${  String(marker.name) }</h2><address>${ addrTrigger(poi, marker) }</address>`, "symbol": "/images/home.svg", "title": langRef[document.body.id][languageOfUser].PDV_TITLE_HOME, "active": true, "default": true},
			"baby": {"content": `<ul><li class='${ ((poi.tags["diaper"] == "yes" || poi.tags["diaper"] == "bench" || poi.tags["diaper"] == "room") ? "color-green" : "color-red") }'>${ ((poi.tags["diaper"] == "yes") ? langRef[document.body.id][languageOfUser].PDV_DIAPER_YES : ((poi.tags["diaper"] == "bench") ? langRef[document.body.id][languageOfUser].PDV_DIAPER_BENCH : ((poi.tags["diaper"] == "room") ? langRef[document.body.id][languageOfUser].PDV_DIAPER_ROOM : ((poi.tags["diaper"] == "no") ? langRef[document.body.id][languageOfUser].PDV_DIAPER_NO : "NODISPLAY")))) }\n<ul><li>${ ((poi.tags["diaper:male"] == "yes") ? langRef[document.body.id][languageOfUser].PDV_DIAPER_MALE : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper:female"] == "yes") ? langRef[document.body.id][languageOfUser].PDV_DIAPER_FEMALE : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper:unisex"] == "yes") ? langRef[document.body.id][languageOfUser].PDV_DIAPER_UNISEX : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper:fee"] == "yes") ? + langRef[document.body.id][languageOfUser].PDV_DIAPER_FEE : "NODISPLAY") }</li></ul>\n</li>\n<li class='${ ((poi.tags["highchair"] == "yes" || poi.tags["highchair"] > 0) ? "color-green" : "color-red") }'>${ ((poi.tags["highchair"] == "yes") ? langRef[document.body.id][languageOfUser].PDV_HIGHCHAIR_YES : ((poi.tags["highchair"] == "no") ? langRef[document.body.id][languageOfUser].PDV_HIGHCHAIR_NO : ((poi.tags["highchair"]) > 0) ? poi.tags["highchair"] + " " + langRef[document.body.id][languageOfUser].PDV_HIGHCHAIR_COUNT : ((poi.tags["highchair"] == "no") ? langRef[document.body.id][languageOfUser].PDV_HIGHCHAIR_NO : "NODISPLAY"))) }</li>\n<li class='${ ((poi.tags["stroller"] == "yes") ? "color-green" : ((poi.tags["stroller"] == "limited") ? "color-yellow" : ((poi.tags["stroller"] == "no") ? "color-red" : "color-grey"))) }'>${ ((poi.tags["stroller"] == "yes") ? langRef[document.body.id][languageOfUser].PDV_STROLLER_YES : ((poi.tags["stroller"] == "limited") ? langRef[document.body.id][languageOfUser].PDV_STROLLER_LIMITED : ((poi.tags["stroller"] == "no") ? langRef[document.body.id][languageOfUser].PDV_STROLLER_NO : "NODISPLAY"))) }\n<ul><li>${ ((poi.tags["stroller:description:" + document.body.id]) ? "\"" + poi.tags["stroller:description:" + document.body.id] + "\"" : ((poi.tags["stroller:description"]) ? "\"" + poi.tags["stroller:description"] + "\"" : "NODISPLAY")) }</li></ul>\n</li>\n<li class='${ ((poi.tags["kids_area"] == "yes" && poi.tags["amenity"] != "kindergarten") ? "color-green" : ((poi.tags["kids_area"] == "no") ? "color-red" : "color-grey")) }'>${ ((poi.tags["kids_area"] == "yes") ? langRef[document.body.id][languageOfUser].PDV_KIDSAREA_YES : ((poi.tags["kids_area"] == "no") ? langRef[document.body.id][languageOfUser].PDV_KIDSAREA_NO : ((poi.tags["amenity"] != "kindergarten" || poi.tags["amenity"] != "childcare") ? langRef[document.body.id][languageOfUser].PDV_KIDSAREA_UNKNOWN : "NODISPLAY"))) }</li>\n</ul>`, "symbol": "/images/baby.svg", "title": langRef[document.body.id][languageOfUser].PDV_TITLE_BABY, "active": true},
			"opening_hours": {"content": `${ parseOpening_hours(poi.tags["opening_hours"]) || "NODISPLAY" }`, "symbol": "/images/clock.svg", "title": langRef[document.body.id][languageOfUser].PDV_TITLE_OH, "active": true},
			"contact" : {"content": `<div clas='grid-container'><a target='_blank' href='${ poi.tags["website"] || poi.tags["contact:website"] || "NODISPLAY" }'><img class='small-icon' src='/images/www.svg' />${ poi.tags["website"] || poi.tags["contact:website"] || "NODISPLAY" }</a></div>\n<div clas='grid-container'><a href='tel:${ poi.tags["phone"] || poi.tags["contact:phone"] || "NODISPLAY" }'><img class='small-icon' src='/images/call.svg' />${ poi.tags["phone"] || poi.tags["contact:phone"] || "NODISPLAY" }</a></div>\n<div clas='grid-container'><a target='_blank' href='${ ((poi.tags["facebook"] != undefined) ? ((poi.tags["facebook"].indexOf("/") > -1) ? poi.tags["facebook"] : ((poi.tags["facebook"] == -1) ? "https://www.facebook.com/" + poi.tags["facebook"] : undefined)) : ((poi.tags["contact:facebook"] != undefined) ? ((poi.tags["contact:facebook"].indexOf("/") > -1) ? poi.tags["contact:facebook"] : ((poi.tags["contact:facebook"] == -1) ? "https://www.facebook.com/" + poi.tags["contact:facebook"] : "NODISPLAY")) : "NODISPLAY")) }'><img class='small-icon' src='/images/facebook-logo.svg' />${ ((poi.tags["facebook"] != undefined) ? ((poi.tags["facebook"].indexOf("/") > -1) ? poi.tags["facebook"] : ((poi.tags["facebook"] == -1) ? "https://www.facebook.com/" + poi.tags["facebook"] : undefined)) : ((poi.tags["contact:facebook"] != undefined) ? ((poi.tags["contact:facebook"].indexOf("/") > -1) ? poi.tags["contact:facebook"] : ((poi.tags["contact:facebook"] == -1) ? "https://www.facebook.com/" + poi.tags["contact:facebook"] : "NODISPLAY")) : "NODISPLAY")) }</a></div>`, "symbol": "/images/contact.svg", "title": langRef[document.body.id][languageOfUser].PDV_TITLE_CONTACT, "active": true},
			"furtherInfos": {"content": `<b>${ langRef[document.body.id][languageOfUser].PDV_OPERATOR }":</b><br/>" ${ ((poi.tags["operator"]) ? poi.tags["operator"] + "<br/>" : "NODISPLAY") }\n<b>${ langRef[document.body.id][languageOfUser].PDV_DESCRIPTION }:</b><br/>${ ((poi.tags["description:" + languageOfUser]) ? langRef[document.body.id][languageOfUser].PDV_DESCRIPTION + ": " + poi.tags["description:" + languageOfUser] : ((poi.tags["description"]) ? langRef[document.body.id][languageOfUser].PDV_DESCRIPTION + ": " + poi.tags["description"] : "NODISPLAY")) }\n<a target='_blank' href='${ "https://www.openstreetmap.org/" + String(poi.type).toLowerCase() + "/" + String(poi.id) }'>${ langRef[document.body.id][languageOfUser].LNK_OSM_VIEW }</a><br/>\n<a href='${ "geo:" + poi.lat + "," + poi.lon }'>${ langRef[document.body.id][languageOfUser].LNK_OPEN_WITH }</a>`, "symbol": "/images/moreInfo.svg", "title": langRef[document.body.id][languageOfUser].PDV_TITLE_MI, "active": true}
			}
			var details_data_old = {"home": {"elements": {"<h1>%s</h1>": ((poi.tags["name"] == undefined) ? ((poi.tags["amenity"] == "toilets") ? langRef[document.body.id][languageOfUser].TOILET : langRef[document.body.id][languageOfUser].PDV_UNNAME) : poi.tags["name"]), "<h2>%s</h2>": String(marker.name), "%s": addrTrigger}, "symbol": "/images/home.svg", "title": langRef[document.body.id][languageOfUser].PDV_TITLE_HOME, "active": true, default: true},
