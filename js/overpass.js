...
<<<<<<< HEAD
			"baby": {"content": `<ul><li class='${ ((poi.tags["diaper:description"]) ? "list-style-none " : "") }${ ((poi.tags["diaper"] && poi.tags["diaper"] != "no") ? "color-green" : ((poi.tags["diaper"]) ? "color-red" : "color-grey")) }'>${ ((poi.tags["diaper"] && poi.tags["diaper:description"]) ? "<details><summary>" + getText().PDV_DIAPER_YES + " <img src='/images/info.svg' class='text-icon' /></summary><div class='description'>\"" + poi.tags["diaper:description"] + "\"</div></details>" : ((poi.tags["diaper"] && poi.tags["diaper"] != "no") ? getText().PDV_DIAPER_YES : ((poi.tags["diaper"] == "no") ? getText().PDV_DIAPER_NO : getText().PDV_DIAPER_UNKNOWN))) }\n<ul><li>${ ((poi.tags["diaper"] == "room") ? getText().PDV_DIAPER_ROOM : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper:male"] && poi.tags["diaper:male"] != "no") ? getText().PDV_DIAPER_MALE : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper:female"] && poi.tags["diaper:female"] != "no") ? getText().PDV_DIAPER_FEMALE : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper:unisex"] && poi.tags["diaper:unisex"] == "yes") ? getText().PDV_DIAPER_UNISEX : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper"] != undefined) ? ((poi.tags["diaper:fee"] == "yes") ? + getText().PDV_DIAPER_FEE : ((poi.tags["diaper"] == "no") ? getText().PDV_DIAPER_FEE_NO : getText().PDV_DIAPER_FEE_UNKNOWN)) : "NODISPLAY") }</li></ul>\n</li>\n<li class='${ ((poi.tags["highchair"] == "yes" || poi.tags["highchair"] > 0) ? "color-green" : ((poi.tags["highchair"]) ? "color-red" : "color-grey")) }'>${ ((poi.tags["highchair"] == "yes") ? getText().PDV_HIGHCHAIR_YES : ((poi.tags["highchair"] == "no") ? getText().PDV_HIGHCHAIR_NO : ((poi.tags["highchair"]) > 0) ? poi.tags["highchair"] + " " + getText().PDV_HIGHCHAIR_COUNT : ((poi.tags["highchair"] == "no") ? getText().PDV_HIGHCHAIR_NO : ((marker.address.startsWith("eat")) ? getText().PDV_HIGHCHAIR_UNKNOWN : "NODISPLAY")))) }</li>\n<li class='${ ((poi.tags["stroller:description"]) ? "list-style-none " : "") }${ ((poi.tags["stroller"] == "yes" || poi.tags["stroller"] == "yes" && poi.tags["stroller:description"]) ? "color-green" : ((poi.tags["stroller"] == "limited" || poi.tags["stroller"] == "limited" && poi.tags["stroller:description"]) ? "color-yellow" : ((poi.tags["stroller"] == "no" || poi.tags["stroller"] == "no" && poi.tags["stroller:description"]) ? "color-red" : "color-grey"))) }'>${ ((poi.tags["stroller"] && poi.tags["stroller:description"]) ? "<details><summary>" + getText().PDV_STROLLER_YES + " <img src='/images/info.svg' class='text-icon' /></summary><div class='description'>\"" + poi.tags["stroller:description"] + "\"</div>" : ((poi.tags["stroller"] == "yes") ? getText().PDV_STROLLER_YES : ((poi.tags["stroller"] == "limited") ? getText().PDV_STROLLER_LIMITED : ((poi.tags["stroller"] == "no") ? getText().PDV_STROLLER_NO : getText().PDV_STROLLER_UNKNOWN)))) }</li>\n<li class='${ ((poi.tags["kids_area"] == "yes" && poi.tags["amenity"] != "kindergarten") ? "color-green" : ((poi.tags["kids_area"] == "no") ? "color-red" : "color-grey")) }'>${ ((poi.tags["kids_area"] == "yes") ? getText().PDV_KIDSAREA_YES : ((poi.tags["kids_area"] == "no") ? getText().PDV_KIDSAREA_NO : ((!marker.address.startsWith("childcare")) ? getText().PDV_KIDSAREA_UNKNOWN : "NODISPLAY"))) }</li>\n</ul>`, "symbol": "/images/baby.svg", "title": getText().PDV_TITLE_BABY, "active": true},
=======
			"baby": {"content": `<ul><li class='${ ((poi.tags["diaper"] && poi.tags["diaper"] != "no") ? "color-green" : ((poi.tags["diaper"]) ? "color-red" : "color-grey")) }'>${ ((poi.tags["diaper"] && poi.tags["diaper:description"]) ? "<details><summary>" + getText().PDV_DIAPER_YES + "ℹ️</summary><div class='description'>\"" + poi.tags["diaper:description"] + "\"<img src='/images/info.svg' class='text-icon' /></div></details>" : ((poi.tags["diaper"] && poi.tags["diaper"] != "no") ? getText().PDV_DIAPER_YES : ((poi.tags["diaper"] == "no") ? getText().PDV_DIAPER_NO : getText().PDV_DIAPER_UNKNOWN))) }\n<ul><li>${ ((poi.tags["diaper"] == "room") ? getText().PDV_DIAPER_ROOM : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper:male"] && poi.tags["diaper:male"] != "no") ? getText().PDV_DIAPER_MALE : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper:female"] && poi.tags["diaper:female"] != "no") ? getText().PDV_DIAPER_FEMALE : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper:unisex"] && poi.tags["diaper:unisex"] == "yes") ? getText().PDV_DIAPER_UNISEX : "NODISPLAY") }</li></ul>\n<ul><li>${ ((poi.tags["diaper"] != undefined) ? ((poi.tags["diaper:fee"] == "yes") ? + getText().PDV_DIAPER_FEE : ((poi.tags["diaper"] == "no") ? getText().PDV_DIAPER_FEE_NO : getText().PDV_DIAPER_FEE_UNKNOWN)) : "NODISPLAY") }</li></ul>\n</li>\n<li class='${ ((poi.tags["highchair"] == "yes" || poi.tags["highchair"] > 0) ? "color-green" : ((poi.tags["highchair"]) ? "color-red" : "color-grey")) }'>${ ((poi.tags["highchair"] == "yes") ? getText().PDV_HIGHCHAIR_YES : ((poi.tags["highchair"] == "no") ? getText().PDV_HIGHCHAIR_NO : ((poi.tags["highchair"]) > 0) ? poi.tags["highchair"] + " " + getText().PDV_HIGHCHAIR_COUNT : ((poi.tags["highchair"] == "no") ? getText().PDV_HIGHCHAIR_NO : ((marker.address.startsWith("eat")) ? getText().PDV_HIGHCHAIR_UNKNOWN : "NODISPLAY")))) }</li>\n<li class='${ ((poi.tags["stroller"] == "yes" || poi.tags["stroller"] == "yes" && poi.tags["stroller:description"]) ? "color-green" : ((poi.tags["stroller"] == "limited" || poi.tags["stroller"] == "limited" && poi.tags["stroller:description"]) ? "color-yellow" : ((poi.tags["stroller"] == "no" || poi.tags["stroller"] == "no" && poi.tags["stroller:description"]) ? "color-red" : "color-grey"))) }'>${ ((poi.tags["stroller"] && poi.tags["stroller:description"]) ? "<details><summary>" + getText().PDV_STROLLER_YES + "&nbsp;<img src='/images/info.svg' class='text-icon' /></summary><div class='description'>\"" + poi.tags["stroller:description"] + "\"</div>" : ((poi.tags["stroller"] == "yes") ? getText().PDV_STROLLER_YES : ((poi.tags["stroller"] == "limited") ? getText().PDV_STROLLER_LIMITED : ((poi.tags["stroller"] == "no") ? getText().PDV_STROLLER_NO : getText().PDV_STROLLER_UNKNOWN)))) }</li>\n<li class='${ ((poi.tags["kids_area"] == "yes" && poi.tags["amenity"] != "kindergarten") ? "color-green" : ((poi.tags["kids_area"] == "no") ? "color-red" : "color-grey")) }'>${ ((poi.tags["kids_area"] == "yes") ? getText().PDV_KIDSAREA_YES : ((poi.tags["kids_area"] == "no") ? getText().PDV_KIDSAREA_NO : ((!marker.address.startsWith("childcare")) ? getText().PDV_KIDSAREA_UNKNOWN : "NODISPLAY"))) }</li>\n</ul>`, "symbol": "/images/baby.svg", "title": getText().PDV_TITLE_BABY, "active": true},
>>>>>>> 451ea22f1f6e9bc3b2259cc4e069b3ca86e6f57c
