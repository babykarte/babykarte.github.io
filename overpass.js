...
function loadPOIS(e, url) {
	...
	$.get(url, function (osmDataAsJson) {
		...
		for (var poi in osmDataAsJson.elements) {
			...
			"contact": {"elements": {"<a target=\"_blank\" href='%s'><img class='small-icon' src='/www.svg' /></a>": poi.tags["website"] || poi.tags["contact:website"] || "","%s<br/><!--Keep note as workaround for a bug-->": poi.tags["website"] || poi.tags["contact:website"] || "", "<a href='tel:%s'><img class='small-icon' src='/call.svg' /></a>": poi.tags["phone"] || poi.tags["contact:phone"] || "","%s<br/><!--Keep note as workaround for a bug-->": poi.tags["phone"] || poi.tags["contact:phone"] || "", "<a href='mailto:%s'><img class='small-icon' src='/email.png' /></a>": poi.tags["email"] || poi.tags["contact:email"] || "", "%s<br/><!--Keep note as workaround for a bug-->": poi.tags["email"] || poi.tags["contact:email"] || "", "<a target='\"_blank\" href='%s'><img class='small-icon' src='/facebook-logo.svg' /></a>": ((poi.tags["facebook"] != undefined) ? ((poi.tags["facebook"].indexOf("/") > -1) ? poi.tags["facebook"] : ((poi.tags["facebook"] == -1) ? "https://www.facebook.com/" + poi.tags["facebook"] : undefined)) : ((poi.tags["contact:facebook"] != undefined) ? ((poi.tags["contact:facebook"].indexOf("/") > -1) ? poi.tags["contact:facebook"] : ((poi.tags["contact:facebook"] == -1) ? "https://www.facebook.com/" + poi.tags["contact:facebook"] : "")) : ""))}, "symbol": "/contact.svg", "title": langRef[document.body.id][languageOfUser].PDV_TITLE_CONTACT, "active": true},
