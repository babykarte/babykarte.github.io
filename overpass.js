...
function loadPOIS(e, url) {
	...
	$.get(url, function (osmDataAsJson) {
		...
		for (var poi in osmDataAsJson.elements) {
			...
			"contact": {"elements": {"<a target='_blank' href='%s'><img class='small-icon' src='/www.svg' />%s</a><br/>": poi.tags["website"] || poi.tags["contact:website"] || "", "<a href='tel:%s'><img class='small-icon' src='/call.svg' />%s</a><br/>": poi.tags["phone"] || poi.tags["contact:phone"] || "", "<a href='mailto:%s'><img class='small-icon' src='/email.png' />%s</a><br/>": poi.tags["email"] || poi.tags["contact:email"] || "", "<a target=''_blank' href='%s'><img class='small-icon' src='/facebook-logo.svg' />%s</a>": ((poi.tags["facebook"] != undefined) ? ((poi.tags["facebook"].indexOf("/") > -1) ? poi.tags["facebook"] : ((poi.tags["facebook"] == -1) ? "https://www.facebook.com/" + poi.tags["facebook"] : undefined)) : ((poi.tags["contact:facebook"] != undefined) ? ((poi.tags["contact:facebook"].indexOf("/") > -1) ? poi.tags["contact:facebook"] : ((poi.tags["contact:facebook"] == -1) ? "https://www.facebook.com/" + poi.tags["contact:facebook"] : "")) : ""))}, "symbol": "/contact.svg", "title": langRef[document.body.id][languageOfUser].PDV_TITLE_CONTACT, "active": true},
